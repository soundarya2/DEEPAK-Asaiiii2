...
public interface MatchOperations {
	...
	public void updateScore(ResourceResolver resolver, String currentMatchPath,String currentInnings, String currentBowlerPath , String currentBatsmanPath , String currentBattingTeamPath, String currentBowlingTeamPath, Integer currentBall, Integer currentOver, Integer currentBallRun, String currentBallRunType, boolean isWicket, boolean isBallValid, boolean isPowerPlay, Integer firstInningsTotal,Integer firstInningsWickets, Integer secondInningsTotal, Integer secondInningsWickets, Integer extras, String [] thisOver,Integer runsToBeUpdated, Integer Overs) throws UnsupportedRepositoryOperationException, RepositoryException ;
}
